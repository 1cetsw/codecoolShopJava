...
<%@page import="com.codecool.shop.dao.*" %>
<!DOCTYPE html>
<html>
<head>
...
<h1 class="text-warning">User successfully registered!</h1>
<button class="btn btn-warning " onclick="location.href='emp-login.jsp'" style="height:auto;">Login
</button>
<button class="btn btn-warning" onclick="location.href='<%= response.encodeURL(request.getContextPath() + "/") %>'"
